function [Vdifference,Vbought,Vsold,Vmarket,uBuy,uSell] = tradedVolumesMultiple(n,horizon,prices,portfolio,modifyUorNot,numStocks,volumesTraded,minOpt,maxOpt,currentSD)
%%%%%INPUTS
...
for i = 1:intervals
    if modifyUorNot == 1
        [uBuy(i,:),uSell(i,:)] = modifyUMultiple(portfolio,numStocks,minOpt,maxOpt,currentSD);                
    else
