...
maxModifyU = 30000;%[10000 20000 30000 40000 60000 90000 120000 150000 200000];
        ...
        for j=1:pseudoMC %pseudo MC loop
            ...
            for modifyUorNot = 1:1
                ...
                for i=1:numDays
                    ...
                    [Vdifference,Vbought,Vsold,Vmarket,uBuy,uSell] = tradedVolumes(interval,horizon,prices, portfolio,modifyUorNot,numStocks,volumesTraded,minModifyU(minIndex),maxModifyU(maxIndex),currentSD);
                    ...
                    % next day, the starting price is the last price of yesteday
                ...
                if graph_total == 1
                    ...
                    legend('Difference')
                    title(['Evolution of Difference for GS, MS, C, WFC, and JPM over ' ...
